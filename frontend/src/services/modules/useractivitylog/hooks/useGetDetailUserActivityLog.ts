...
import { ResponseUserActivityLogDetail, UserActivityLogDetail } from "../interfaces/useractivitylog.interface";
...
const useGetDetailUserActivityLog = (
    ...
    const fetch: () => Promise<ResponseUserActivityLogDetail> | undefined =
        useCallback(() => {
            if (!isTrigger) {
                return;
            }
    ...
    const checkConditionPass = useCallback(
        (response: ResponseUserActivityLogDetail) => {
