                                    ...
                                    {loading ? (
                                        ...
                                        <div className="space-y-6">
                                            ...
                                            <div className="bg-gray-50 rounded-lg p-3">
                                                <p className="text-xs text-gray-500 font-mono">ID: {dataFeedbackDetail.feedbackId}</p>
                                            </div>
                                            ...
                                            <div className="flex items-start gap-4">
                                                ...
                                                <div className="flex-1">
                                                    <h3 className="text-lg font-semibold text-gray-900 mb-2">{dataFeedbackDetail.title}</h3>
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                                                        ...
                                                        <div className="flex items-center gap-2 text-gray-600">
                                                            ...
                                                            {convertUTCToVietnamTime(dataFeedbackDetail.createdAt, DateTimeFormat.DateTimeWithTimezone)?.toString() || 'N/A'}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <div className="bg-gray-50 rounded-lg p-4 border">
                                                    <p className="text-gray-700 whitespace-pre-wrap leading-relaxed">{truncateContent(dataFeedbackDetail.content)}</p>
                                                </div>
                                            </div>
                                        </div>
                                    ) : null}
