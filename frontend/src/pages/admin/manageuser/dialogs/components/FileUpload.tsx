...
const FileUpload: React.FC<{
  ...
  <Card className="border-0 shadow-lg">
    <CardContent className="p-8">
      ...
      <div className="mb-6">
        <h3 className="mb-2 text-xl font-bold text-gray-900">Chọn file để import</h3>
        <p className="text-gray-600">
          Kéo thả file vào đây hoặc click để chọn file từ máy tính của bạn
        </p>
      </div>
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <div>
                <p className="mb-1 text-lg font-semibold text-gray-900">
                  Chọn file Excel hoặc CSV để upload
                </p>
                <p className="text-sm text-gray-500">Hỗ trợ .xlsx, .xls, .csv (tối đa 10MB)</p>
              </div>
            </div>
          )}
        </label>
